...
if __name__ == '__main__':
    ...
    for student in list_of_students:
        ...
        if not "No submission was found under the prog2_encryption tag for the encryption task\n" in existing_feedback:
            ...
            if len(files_created) == 0:
               no_created_files = True
                ...
                try:
                    ...
                    file_1 = (
                        open(f'./results_encrypt/test_file1_{student}.txt', 'r')).readline()
                    if file_1 == "a broken clock is right twice a day":
                        file_1_mark = 1
                    else:
                    ...
                    try:
                        file_1 = (
                            open(f'./results_encrypt/test_file1_{student}','r')).readline()
                        if file_1 == "a broken clock is right twice a day":
                            file_1_mark = 1
                        else:
                            incorrect_score_1 = True
                ...
                try:
                    file_2 = (
                        open(f'./results_encrypt/test_file2_{student}.txt', 'r')).readline()
                    if file_2 == "though clocks cannot think for themselves":
                        file_2_mark = 1
                    else:
                    ...
                    try:
                        file_2 = (
                            open(f'./results_encrypt/test_file2_{student}', 'r')).readline()
                        if file_2 == "though clocks cannot think for themselves":
                            file_2_mark = 1
                        else:
                            incorrect_score_2 = True
                ...
                try:
                    file_3 = (
                        open(f'./results_encrypt/test_file3_{student}.txt', 'r')).readline()
                    if file_3 == "but if they could they would probably tick along quite nicely":
                        file_3_mark = 1
                    else:
                    ...
                    try:
                        file_3 = (
                            open(f'./results_encrypt/test_file3_{student}', 'r')).readline()
                        if file_3 == "but if they could they would probably tick along quite nicely":
                            file_3_mark = 1
                        else:
                            incorrect_score_3 = True
